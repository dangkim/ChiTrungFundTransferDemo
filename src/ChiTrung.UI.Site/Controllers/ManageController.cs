...
using System.Text;
using ChiTrung.Infra.CrossCutting.Identity.Extensions;
using ChiTrung.Infra.CrossCutting.Identity.Models;
using ChiTrung.Infra.CrossCutting.Identity.Services;
using ChiTrung.Infra.CrossCutting.Identity.Models.ManageViewModels;
using ChiTrung.UI.Site.Extensions;
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ChiTrung Project"),
